...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      confirm() {
        this.busy = true
        if(this.data.committee.loc_cn_3 % 2 == 0 && this.data.committee.loc_en_1 % 2 == 0 && this.data.committee.loc_en_2 % 2 == 0 && this.data.committee.loc_en_3 % 2 == 0){
